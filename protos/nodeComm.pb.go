...
func (x *DataStreamReq) Reset() {
	*x = DataStreamReq{}
	mi := &file_protos_nodeComm_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataStreamReq) Descriptor() ([]byte, []int) {
	return file_protos_nodeComm_proto_rawDescGZIP(), []int{7}
}
...
const file_protos_nodeComm_proto_rawDesc = "" +
	...
	"\x03end\x18\x02 \x01(\x04R\x03end\"S\n" +
...
var file_protos_nodeComm_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_protos_nodeComm_proto_goTypes = []any{
	...
	(*Range)(nil),         // 6: protos.Range
	(*DataStreamReq)(nil), // 7: protos.DataStreamReq
}
